...
class Game:
    ...
    def get_winner(self):
        ...
        elif self.user_choice == 1 and self.comp_choice == 2:
            print('You are winner')
        elif self.user_choice == 2 and self.comp_choice == 0:
            print('you are winner')
        elif self.user_choice == 0 and self.comp_choice ==2:
            print('you lost')
        elif self.user_choice == 2 and self.comp_choice ==0:
            print('you are winner')
        elif self.user_choice == 1 and self.comp_choice ==0:
            print('you lost')
        elif self.user_choice ==1 and self.comp_choice == 2:
            print('you are winner')
